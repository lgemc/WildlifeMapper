...
uv run  tools/inference.py +image_dir=data/intermediate/patches_1024_1024/images/test/ +gt_csv=data/intermediate/patches_1024_1024/annotations/test.csv +output_dir=outputs/ +model.name=vit_b +device=cuda
