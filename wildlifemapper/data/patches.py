...
class PatchesBuffer:
    ...
    def __init__(
        ...
        Args:
            ...
            min_visibility (float, optional): minimum fraction of area for
                an annotation to be kept. Defaults to 0.1.
            images_col (str, optional): name of the column containing image names.
                Defaults to 'images'.
            labels_col (str, optional): name of the column containing labels.
                Defaults to 'labels'.
        '''
        ...
        self.data = AnnotationsFromCSV(self.csv_file, images_col, labels_col)
